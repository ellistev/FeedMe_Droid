		...
		com.radiusnetworks.ibeacon.MonitorNotifier
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("iBeacon_Indexer.MonitorNotifier, iBeacon_Indexer, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MonitorNotifier.class, __md_methods);
	}
	...
	public MonitorNotifier () throws java.lang.Throwable
	{
		...
		if (getClass () == MonitorNotifier.class)
			mono.android.TypeManager.Activate ("iBeacon_Indexer.MonitorNotifier, iBeacon_Indexer, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
